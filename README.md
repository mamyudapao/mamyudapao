<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=00ADD8&vCenter=true&width=600&lines=Distributed+Systems+Engineer;Stateful+Microservices+at+Scale;Go+%2B+Kubernetes+%2B+gRPC" alt="Typing SVG" />
...
<table>
  ...
  <tr>
    ...
    <td>
      <img src="https://img.shields.io/badge/pprof-00ADD8?style=flat-square&logo=go&logoColor=white" />
...
```mermaid
graph LR
    A[🎯 Live Streaming Re-architecture] --> B[Go Microservices]
    A --> C[Stateful Architecture]
    A --> D[Event-Driven Design]
    B --> E[Clean Architecture & DI]
    C --> F[Push/Drain & Graceful Shutdown]
    D --> G[Redis Streams & Consumer Groups]
    style A fill:#00ADD8,color:#fff,stroke:none
    style B fill:#326CE5,color:#fff,stroke:none
...
<p>
  <a href="https://blog-tech-livid.vercel.app/">
    <img src="https://img.shields.io/badge/Tech_Blog-000000?style=for-the-badge&logo=vercel&logoColor=white" />
  </a>
